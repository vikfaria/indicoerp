...
export default function Print() {
    ...
    const customer = resolveSalesDocumentCounterparty(invoice as Record<string, any>);
                    ...
                    <div className="text-right w-1/2">
                        ...
                        <div className="text-sm space-y-1">
                            {customer.shipping_address ? (
                                <>
                                    <p className="font-semibold">{customer.shipping_address.name}</p>
                                    <p>{customer.shipping_address.address_line_1}</p>
                                    <p>{customer.shipping_address.city}, {customer.shipping_address.state} {customer.shipping_address.zip_code}</p>
                                </>
                            ) : (
