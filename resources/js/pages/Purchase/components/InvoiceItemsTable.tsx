...
export default function InvoiceItemsTable({ items, onChange, errors, products = [], vatCodes = [], showAddButton = true }: Props) {
    ...
    const recalculateItem = (item: PurchaseInvoiceItem) => {
