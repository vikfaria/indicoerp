import { Palette, Building, Settings as SettingsIcon, Search, HardDrive, Mail, Cookie, Trash2, DollarSign, CreditCard, FileText, Radio, ShieldCheck } from 'lucide-react';
...
export const getSuperAdminSettings = (t: (key: string) => string): SettingMenuItem[] => [
  ...
  {
    order: 1010,
    title: t('Company Overrides'),
    href: '#company-overrides-settings',
    icon: ShieldCheck,
    permission: 'manage-company-overrides',
    component: 'company-overrides-settings'
  }
];
