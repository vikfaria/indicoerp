...
export default function EditBankAccount({ bankaccount, onSuccess }: EditBankAccountProps) {
    ...
    const { data, setData, put, processing, errors } = useForm<EditBankAccountFormData>({
        ...
        is_electronic_money_account: bankaccount.is_electronic_money_account ?? false,
        electronic_money_entity: bankaccount.electronic_money_entity ?? '',
        electronic_money_level: bankaccount.electronic_money_level ?? '',
        electronic_money_daily_limit_mzn: bankaccount.electronic_money_daily_limit_mzn?.toString() ?? '',
        electronic_money_monthly_limit_mzn: bankaccount.electronic_money_monthly_limit_mzn?.toString() ?? '',
        electronic_money_limit_exempt_for_enterprise: bankaccount.electronic_money_limit_exempt_for_enterprise ?? false,
        electronic_money_account_purpose: bankaccount.electronic_money_account_purpose ?? '',
