...
namespace Workdo\Aamarpay\Database\Seeders;
...
class PermissionTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $permission = [
            ['name' => 'edit-aamarpay-settings', 'module' => 'aamarpay', 'label' => 'Edit Aamarpay Settings'],
            ['name' => 'manage-aamarpay-settings', 'module' => 'aamarpay', 'label' => 'Manage Aamarpay Settings'],
        ];
