...
class PermissionTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $permission = [
            ['name' => 'edit-authorizenet-settings', 'module' => 'authorizenet', 'label' => 'Edit AuthorizeNet Settings'],
            ['name' => 'manage-authorizenet-settings', 'module' => 'authorizenet', 'label' => 'Manage AuthorizeNet Settings'],
        ];
