...
class PermissionTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $permission = [
            ...
            ['name' => 'view-sensitive-employee-data', 'module' => 'employees', 'label' => 'View Sensitive Employee Data'],
            ...
            ['name' => 'manage-confidential-complaints', 'module' => 'complaints', 'label' => 'Manage Confidential Complaints'],
