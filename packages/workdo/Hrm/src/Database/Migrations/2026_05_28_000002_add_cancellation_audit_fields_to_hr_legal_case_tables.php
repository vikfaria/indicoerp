...
return new class extends Migration
{
    ...
    {
        $this->addCancellationColumns('warnings');
        $this->addCancellationColumns('complaints');
        $this->addCancellationColumns('terminations');
        $this->addCancellationColumns('resignations');
    }

    public function down(): void
    {
        $this->dropCancellationColumns('warnings');
        $this->dropCancellationColumns('complaints');
        $this->dropCancellationColumns('terminations');
        $this->dropCancellationColumns('resignations');
    }
