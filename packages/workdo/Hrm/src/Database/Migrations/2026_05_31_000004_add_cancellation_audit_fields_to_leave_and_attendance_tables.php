...
return new class extends Migration
{
    ...
    {
        $this->addCancellationColumns('leave_applications');
        $this->addCancellationColumns('attendances');
    }

    public function down(): void
    {
        $this->dropCancellationColumns('leave_applications');
        $this->dropCancellationColumns('attendances');
    }
