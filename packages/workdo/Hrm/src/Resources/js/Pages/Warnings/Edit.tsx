...
export default function EditWarning({ warning, onSuccess }: EditWarningProps) {
    ...
    const { data, setData, put, processing, errors } = useForm<EditWarningFormData>({
        ...
        note_of_culpa_issued_at: warning.note_of_culpa_issued_at || '',
        note_of_culpa_delivered_at: warning.note_of_culpa_delivered_at || '',
        worker_refused_note_of_culpa: !!warning.worker_refused_note_of_culpa,
        refusal_witness_one_name: warning.refusal_witness_one_name || '',
        refusal_witness_two_name: warning.refusal_witness_two_name || '',
        response_deadline_at: warning.response_deadline_at || '',
        decision_deadline_at: warning.decision_deadline_at || '',
        disciplinary_sanction: warning.disciplinary_sanction || '',
        disciplinary_decision_at: warning.disciplinary_decision_at || '',
