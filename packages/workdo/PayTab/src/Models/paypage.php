...
namespace Workdo\PayTab\Models;

use Illuminate\Support\Facades\Redirect;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Session;
use Workdo\PayTab\Models\paytabs_core;

class paypage 
{
    public  $paytabsinit, $paytabs_core, $paytabs_api, $follow_transaction, $laravel_version, $package_version, $paytabs_core_token;
    ...
    public function sendURLs($return_url)
    {
        $this->paytabs_core->set07URLs($return_url, $return_url);
        return $this;
    }
    ...
    public function create_pay_page($order_id = null)
    {
