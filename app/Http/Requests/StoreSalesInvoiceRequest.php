...
class StoreSalesInvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'warehouse_id' => ['required_if:type,product', 'nullable', 'integer', $this->companyWarehouseExistsRule()],
            'payment_terms' => 'nullable|string|max:255',
            'late_issue_reason' => 'nullable|string|max:1000',
            'notes' => 'nullable|string',
            'items' => 'required|array|min:1',
            'items.*.product_id' => ['required', 'integer', 'min:1', $this->companyProductExistsRule($this->input('type'))],
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator): void {
            ...
            $invoiceType = strtolower((string) $this->input('type', 'service'));
