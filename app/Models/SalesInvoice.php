...
class SalesInvoice extends Model
{
    ...
    protected $casts = [
        ...
        'invoice_date' => 'date',
        'operation_date' => 'date',
        'fiscal_issue_deadline' => 'date',
        'issued_with_delay' => 'boolean',
        'due_date' => 'date',
        'subtotal' => 'decimal:2',
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($invoice) {
            if (empty($invoice->document_type)) {
                $invoice->document_type = static::resolveCompanyDocumentPrefix('sales_invoice_prefix', 'SI', $invoice->created_by);
            }

            if (empty($invoice->document_series)) {
                $invoice->document_series = static::resolveCompanyDocumentSeries('sales_invoice_series', $invoice->created_by, $invoice->warehouse_id);
            }
