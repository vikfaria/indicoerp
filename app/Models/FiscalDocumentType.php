...
class FiscalDocumentType extends Model
{
    ...
    public static function seedDefaults(): void
    {
        $types = [
            ...
            ['code' => 'FR', 'name' => 'Factura-Recibo', 'saft' => 'FR', 'cat' => 'sales', 'hash' => true, 'series' => true, 'credit' => false],
            ...
            ['code' => 'RC', 'name' => 'Recibo', 'saft' => 'RC', 'cat' => 'payments', 'hash' => false, 'series' => true, 'credit' => false],
